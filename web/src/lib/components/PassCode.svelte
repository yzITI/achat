...
<div class="w-full h-full bg-black flex justify-center items-center">
  <div class="p-6 rounded-xl flex flex-col justify-center items-center">
    ...
    <input type="password" class="w-80 px-4 py-2 my-4 bg-neutral-700 rounded outline-none text-lg text-center transition-all focus:bg-neutral-600" placeholder="Enter your PassCode" onkeyup={enter} />
  </div>
</div>
